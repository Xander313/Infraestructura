...
<div class="bg-white border rounded p-5">
    ...
    <form method="POST" action="{{ route('rat.store') }}" id="ratForm">
        @csrf
        ...
        <div x-data="{ tab: 'details' }">
            ...
            <div x-show="tab==='categories'">
                ...
                {{-- input oculto SOLO para validación --}}
            ...
            <div x-show="tab==='transfers'">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                    ...
                    <div class="field-wrapper">
                        <input type="text" name="transfers[0][transfer_type]"
                               placeholder="Tipo de transferencia"
                               class="border p-2 rounded w-full">
                    </div>

                    <div class="field-wrapper">
                        <input type="text" name="transfers[0][safeguard]"
                               placeholder="Salvaguarda"
                               class="border p-2 rounded w-full">
                    </div>

                    <div class="field-wrapper">
                        <input type="text" name="transfers[0][legal_basis_text]"
...
$(function () {
    ...
    // HABILITAR/DESHABILITAR FUENTE SEGÚN CHECKBOX
    $('.category-checkbox').on('change', function () {
    ...
    // ACTUALIZA TABS (ERROR REAL Y PERSISTENTE)
